...
INSERT INTO product (title, price, pdesc) VALUES ("1 + 1 = 10", 34.99, "Binary, am I right. Used in so many things, and most people don't have slightest idea how it works");
...
INSERT INTO product (title, price, pdesc) VALUES ("BigO Vibes", 39.99, "It's very satisfying when you get that O(log n) time. I'd also be careful of anyone who's ok with O(n!)");
...
INSERT INTO product (title, price, pdesc) VALUES ("Full Regex Cheatsheet", 29.99, "Boom, full regex cheetsheet. We already know that every time you write a regex is every time you learn regex, my as well commit to the shirt now");
...
INSERT INTO product_image VALUES (1, "/media/products/daysSinceLastTimezone-1_2.jpg", 2);
INSERT INTO product_image VALUES (1, "/media/products/daysSinceLastTimezone-1_3.jpg", 3);
...
INSERT INTO product_image VALUES (2, "/media/products/itWorksOnMyMachine_2.jpg", 2);
INSERT INTO product_image VALUES (2, "/media/products/itWorksOnMyMachine_3.jpg", 3);
...
INSERT INTO product_image VALUES (3, "/media/products/1p1Equal10_2.jpg", 2);
INSERT INTO product_image VALUES (3, "/media/products/1p1Equal10_3.jpg", 3);
...
INSERT INTO product_image VALUES (4, "/media/products/stopBuggingMe_2.jpg", 2);
INSERT INTO product_image VALUES (4, "/media/products/stopBuggingMe_3.jpg", 3);
...
INSERT INTO product_image VALUES (5, "/media/products/coffeeRefillDrink_2.jpg", 2);
INSERT INTO product_image VALUES (5, "/media/products/coffeeRefillDrink_3.jpg", 3);
...
INSERT INTO product_image VALUES (6, "/media/products/bigOVibes_2.jpg", 2);
INSERT INTO product_image VALUES (6, "/media/products/bigOVibes_3.jpg", 3);
...
INSERT INTO product_image VALUES (7, "/media/products/idiotProofVsBetterIdiots_2.jpg", 2);
INSERT INTO product_image VALUES (7, "/media/products/idiotProofVsBetterIdiots_3.jpg", 3);
...
INSERT INTO product_image VALUES (8, "/media/products/redBlueLine32_2.jpg", 2);
INSERT INTO product_image VALUES (8, "/media/products/redBlueLine32_3.jpg", 3);
...
INSERT INTO product_image VALUES (9, "/media/products/fullRegexCheatSheet_2.jpg", 2);
INSERT INTO product_image VALUES (9, "/media/products/fullRegexCheatSheet_3.jpg", 3);

# important users
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title, profile_picture)
VALUES ("tednugent", "Ted Nugent", "ab148bc57795c415b8dc46bc4ba01744", "I love music as much as the next guy, but programming humor is what I really love. I do lots of it, it's so fun.", "partner", "/media/profiles/TedNugent.jpg");
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title, profile_picture)
VALUES ("tomselleck", "Tom Selleck", "1c2bb845ed42ae28469d362bd8889ffe", "I've done a number of movies in my times, but most people don't notice how often I program, so I've created this page to spread my joy of programming.", "partner", "/media/profiles/TomSelleck.jpg");
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title, profile_picture)
VALUES ("tracymarrow", "Tracy Marrow", "2d08a583daa61da0452fc1a1de38f1fe", "Programming my whole life and it's always a good time, you know. I got nothing without my keyboard.", "partner", "/media/profiles/TracyMarrow.jpg");

# filler users
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('alice_wonder', 'Alice Wonder', '7d793037a0770186574b0282f2f435e7', 'Hey there, I am Alice. I have a knack for solving complex problems and love to share my knowledge.', 'employee');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('bob_miller', 'Bob Miller', '1d2292f5d6b12e0c3e57d52fb5ef7922', 'Hi, I am Bob. I am known for my constructive contributions and detailed code reviews.', 'contributor');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('charlie_jones', 'Charlie Jones', '8f14e45fceaa167a5a36dedd4bea2543', 'Hello, I am Charlie. I enjoy working on front-end development and advocate for clean code.', 'employee');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('david_black', 'David Black', 'e4da3b7fbbcef345d7772b0674a318d5', 'Hi, I am David. I am a backend specialist with extensive experience in database management.', 'contributor');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('eve_white', 'Eve White', '1679091c5a880fef6fb5e6087eb1b2dc', 'Hey, I am Eve. I am an all-rounder with a deep understanding of full-stack development.', 'employee');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('jane_smith', 'Jane Smith', '5d41402abc4b2a76b9719d911017c592', 'Hello, I am Jane. I am a passionate contributor to various coding communities.', 'contributor');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('frank_green', 'Frank Green', '45c48cce2e2d3fbdea1afc51c7c6ad26', 'Hi, I am Frank. I am a seasoned developer who enjoys mentoring junior team members.', 'contributor');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('grace_lee', 'Grace Lee', '03c7c0ace395d82182db07ae2c30f034', 'Hello, I am Grace. I have a long history of contributions to the tech world.', 'employee');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('john_roe', 'John Roe', 'e99a18c428cb38d5f260853678922e03', 'Hi, I am John. I am an experienced software developer who enjoys working on open-source projects.', 'employee');
INSERT INTO user_profile (username, fullname, hashed_password, udesc, title)
VALUES ('henry_clark', 'Henry Clark', 'c4ca4238a0b943820dcc509a6f75849b', 'Hi, I am Henry. I am skilled at finding and fixing bugs quickly and efficiently.', 'contributor');

# Inside man
INSERT INTO user_profile (username, hashed_password, udesc, title)
VALUES ("CM", "286ba48ca4f45dab999e3609fcf562dc", "You will receive instructions from me here<br>https://youtu.be/HIvCb1DAJns", "hidden");
...
5.56x45 mm<br>");
INSERT INTO product_image VALUES (5, "/media/products/M4Carbine.png", 0);
